...
contract ChainList is Ownable {
  ...
  // fetch the numjber of articles in the contract
  function getNumberOfArticles() public view returns (uint) {
    return articleCounter;
  }

  // getch and return all article IDs for articles still for sale
  ...
  function buyArticle(uint _id) payable public {
    // we check whethere there is an article for sale
